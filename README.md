...
* [`psf-bch-wallet multisig-create-op_return-tx`](#psf-bch-wallet-multisig-create-op_return-tx)
...
## `psf-bch-wallet multisig-collect-keys`
...
_See code: [src/commands/multisig-collect-keys.js](https://github.com/Permissionless-Software-Foundation/psf-bch-wallet/blob/vv2.14.2/src/commands/multisig-collect-keys.js)_

## `psf-bch-wallet multisig-create-op_return-tx`

Create a multisig transaction

```
[1mUSAGE[22m
  $ psf-bch-wallet multisig-create-op_return-tx [-w <value>]

[1mFLAGS[22m
  -w, --wallet=[4m<value>[24m  [2mJSON string of the multisig wallet object[22m
...
_See code: [src/commands/multisig-create-op_return-tx.js](https://github.com/Permissionless-Software-Foundation/psf-bch-wallet/blob/vv2.14.2/src/commands/multisig-create-op_return-tx.js)_

## `psf-bch-wallet multisig-create-tx`

Create a multisig transaction

```
[1mUSAGE[22m
  $ psf-bch-wallet multisig-create-tx [-w <value>]
...
_See code: [src/commands/multisig-create-tx.js](https://github.com/Permissionless-Software-Foundation/psf-bch-wallet/blob/vv2.14.2/src/commands/multisig-create-tx.js)_

## `psf-bch-wallet multisig-create-wallet`

Create a multisig wallet

```
[1mUSAGE[22m
  $ psf-bch-wallet multisig-create-wallet [-p <value>]

[1mFLAGS[22m
  -p, --pairs=[4m<value>[24m  [2mJSON string of address-key pairs[22m
...
```
[1mUSAGE[22m
  $ psf-bch-wallet multisig-send-tx [-p <value>] [-t <value>] [-n <value>]

[1mFLAGS[22m
  -n, --name=[4m<value>[24m   [2mName of wallet to pay for messages[22m
  -p, --pairs=[4m<value>[24m  [2mAddress pairs generated by multisig-collect-keys[22m
  -t, --tx=[4m<value>[24m     [2mTransaction generated by multisig-create-tx[22m

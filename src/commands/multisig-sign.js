...
class MultisigSignTx extends Command {
  ...
  async run () {
    try {
      const { flags } = this.parse(MultisigSignTx)
...
MultisigSignTx.description = 'Read signed messages'

MultisigSignTx.flags = {
  name: flags.string({ char: 'n', description: 'Name of wallet' }),
  txid: flags.string({ char: 't', description: 'Transaction ID' })
}

module.exports = MultisigSignTx

/*
  Airdrop a voting token onto a list of addresses. Provide a wallet that contains
  tokens, and the token IDs, and one token will be sent to each address in the
  list.

  The output of the vote-addrs command, is the address-list input to this command.
*/
